    ...
    <style>
        ...
        * {
        ...
        .main-logo {
            ...
            object-fit: cover;
            border-radius: 20px;
            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 0 2px rgba(255, 255, 255, 0.1), 0 0 40px rgba(220, 53, 69, 0.4);
        ...
        .main-logo:hover {
            ...
            box-shadow: 0 30px 60px rgba(0, 0, 0, 0.5), 0 0 0 3px rgba(255, 255, 255, 0.15), 0 0 60px rgba(220, 53, 69, 0.6);
        }
        ...
        .form-card {
            ...
            border-radius: 20px;
            padding: 40px 35px;
            box-shadow: 0 15px 35px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.05), 0 0 20px rgba(220, 53, 69, 0.2);
...
<body>
    <div class="container">
        <div class="logo-side">
            <div class="logo-wrapper">
                <img src="{{ asset('asset/img/LogoKotak.png') }}" alt="Logo" class="main-logo">
                <h1 class="logo-title">SISTEM KEPENDUDUKAN</h1>
                <p class="logo-subtitle">Bergabung dengan sistem informasi terpadu untuk pengelolaan data kependudukan
            ...
            <div class="form-container">
                <div class="form-card">
                    ...
                    <form action="{{ route('signup') }}" method="POST" id="signupForm">
                        ...
                        @if ($errors->any())
                            <div class="alert"><i
                                    class="fas fa-exclamation-circle"></i><span>{{ $errors->first() }}</span></div>
                        @endif
                        @if (session('success'))
                            <div class="alert alert-success"><i
                                    class="fas fa-check-circle"></i><span>{{ session('success') }}</span></div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" id="name-error"><i
                                    class="fas fa-exclamation-circle"></i><span>Nama harus diisi</span></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" id="email-error"><i
                                    class="fas fa-exclamation-circle"></i><span>Email tidak valid</span></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-requirements">
                                <ul>
                                    <li><i class="fas fa-circle requirement-icon invalid"
                                            id="req-length"></i><span>Minimal 8 karakter</span></li>
                                    <li><i class="fas fa-circle requirement-icon invalid"
                                            id="req-uppercase"></i><span>Mengandung huruf besar</span></li>
                                    <li><i class="fas fa-circle requirement-icon invalid"
                                            id="req-number"></i><span>Mengandung angka</span></li>
                                </ul>
                            </div>
                            <div class="invalid-feedback" id="password-error"><i
                                    class="fas fa-exclamation-circle"></i><span>Password tidak memenuhi syarat</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" id="confirm-error"><i
                                    class="fas fa-exclamation-circle"></i><span>Password tidak cocok</span></div>
                        </div>
                    ...
                    <div class="signup-footer">Sudah punya akun? <a href="{{ route('login') }}">Masuk disini</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateSignupButton() {
            signupButton.disabled = !(isValidName && isValidEmail && isValidPassword && isValidConfirm);
        }
