...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary shadow-sm sticky-top py-lg-0 px-lg-5">
    ...
    <a href="{{ route('home') }}" class="navbar-brand d-flex align-items-center ms-4 ms-lg-0 gap-3">
        ...
        <img src="{{ asset('asset/img/LogoPanjang.png') }}" alt="Logo Kependudukan" style="height:75px; width:auto;">

        <span class="fw-bold text-danger text-uppercase fs-3">
            Kependudukan
        </span>
    </a>
                ...
                @if (Auth::user()->role === 'admin')
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark rounded-0">
                            ...
                            <li><a class="dropdown-item" href="{{ route('peristiwa_kelahiran.index') }}">
                                    Peristiwa Kelahiran
                                </a></li>
                        </ul>
                    </li>
